    ...
    <section class="ftco-section ftco-no-pb">
			<div class="container">
	          ...
	          <div class="heading-section">
	            <h2 class="mb-4">Welcome To SheldonHomes A Real Estate Agency</h2>

	            <p>We seek to provide National Service Personnels,  affordable apartments to rent during their year of service. Not only we also seek to provide people who are in need of an affordable place to rent.</p>
	            <p>On here we seek to give our customers Affordabilty, Variety and a good rental payment plan.</p>
    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-md-4">
    				...
    				<p>Our mission is keenly focused on providing convenient and annual accommodation solutions for Low income earners and specifically National Service Personnel whenever they are posted for service in Accra.</p>
    			</div>
    			<div class="col-md-4">
    				<h3 style="font-weight: 600; font-size: 20px;">Our Vission</h3>
    				<p>To maintain our growth by offering our owner clients a superior and distinctive service that safeguards and increases the worth of their asset ensuring that the customers who are tenants receive knowledgeable and respectful service. We will continue to innovate  and improve our services by utilizing cutting-edge technology, tried-and-true policies, and procedures.</p>
    			</div>
