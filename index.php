        ...
        <div class="row no-gutters slider-text justify-content-center align-items-center">
          <div class="col-lg-8 col-md-6 ftco-animate d-flex align-items-end">
          	<div class="text text-center w-100">
	            <h1 class="mb-4">Find Properties <br>All Affordable Properties Here</h1>
        ...
        <div class="row">
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/person_55.jpg);">
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/person_66.jfif);">
        				<a href="properties.php" class="icon d-flex align-items-center justify-content-center btn-custom">
        					<span class="ion-ios-link"></span>
        				</a>
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/person_33.jfif);">
        				<a href="properties.php" class="icon d-flex align-items-center justify-content-center btn-custom">
        					<span class="ion-ios-link"></span>
        				</a>
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/person_44.jfif);">
        				<a href="properties.php" class="icon d-flex align-items-center justify-content-center btn-custom">
        					<span class="ion-ios-link"></span>
        				</a>
        	...
        	<div class="col-md-4">
        		<div class="property-wrap ftco-animate">
        			<div class="img d-flex align-items-center justify-content-center" style="background-image: url(images/person22.jpg);">
        				<a href="properties.php" class="icon d-flex align-items-center justify-content-center btn-custom">
        					<span class="ion-ios-link"></span>
        				</a>
			          ...
			          <div class="col-md-12 d-flex align-self-stretch ftco-animate">
			            <div class="media block-6 services-wrap d-flex">
			              ...
			              <div class="media-body pl-4">
			                <h3>At Most 1 Year Rent Payment In Advance</h3>
			                <p>With our properties, we do not take 2 years rent payment in advance, in the worse case, we take at most one year payment in advance</p>
			              </div>
			            </div>      
			          </div>
			          <div class="col-md-12 d-flex align-self-stretch ftco-animate">
			            <div class="media block-6 services-wrap d-flex">
			              ...
			              <div class="media-body pl-4">
			                ...
			                <p>We take any form of payment, bank transaction, momo, pos etc.</p>
			              </div>
			            </div>      
			          </div>
			          <div class="col-md-12 d-flex align-self-stretch ftco-animate">
			            <div class="media block-6 services-wrap d-flex">
			              ...
			              <div class="media-body pl-4">
			                ...
			                <p>Sit at the comfort of your zone and go through our properties via our site. No need to go door to door asking for a place to rent.</p>
			              </div>
			            </div>      
			          </div>
			          <div class="col-md-12 d-flex align-self-stretch ftco-animate">
			            <div class="media block-6 services-wrap d-flex">
			              ...
			              <div class="media-body pl-4">
			                <h3>Meet Agent</h3>
			                <p>Contact the agent or property owner, and close the deal.</p>
			              </div>
			            </div>      
			          </div>
			        </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="service.php"><span class="icon-long-arrow-right mr-2"></span>About Us</a></li>
