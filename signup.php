...
<nav class="nav-container">
  ...
  <ul class="nav-list">
    ...
    <li class="nav-items"><a href="/join">Join</a></li>
  </ul>
</nav>
  ...
  <div class="form-container">
    <div class="section-header">
      ...
      <h1 class="primary-heading">
        Create a new account<span class="fullstop">.</span>
      </h1>
      <h2 class="secondary-heading">
        Already A Member? <a class="login-link" href="/login">Log in</a>
      </h2>
    </div>
    ...
    <?php include ('errors.php'); ?>
      ...
      <div class="form-input">
		...
		<input type="password" name="password_2" id="password_2" placeholder="Re-Password" />
    <input type="text" name="Gender" id="Gender" placeholder="Gender" />


        <div class="btn-input">
          <button type="button" class="secondary-btn">Forgot Password?</button>
          <button type="submit" name="submit" id="submit" class="primary-btn">Create account</button>
        </div>
      </div>
    </form>
  </div>
