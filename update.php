...
$id = $_SESSION['id'];
$_SESSION['aptid'] = $id;
$sql1 = "SELECT * FROM property where ImagesID = '$id' ";
      ...
      <div class="container">
      	<div class="row justify-content-center">
      		<div class="col-md-12">
				  ...
				  <?php echo "<div class='img rounded' style='background-image: url(images/".$row['ImageName'].");'></div>"?>

				   <a class="img-video popup-vimeo d-flex align-items-center justify-content-center" href= <?php echo 'video/'.$row['videoss'].''?>>


      				<div class="text">
      					<h2>Click on the link to watch video</h2>
      					<span class="subheading">Video of the apartment/room</span>
      				</div>
      			</div>
      		</div>
      	</div>
						...
						<div class="bd-example bd-example-tabs">
							<div class="d-flex">
							  <ul class="nav nav-pills mb-2" id="pills-tab" role="tablist">
							    ...
							    <li class="nav-item">
							      <a class="nav-link active" id="pills-description-tab" data-toggle="pill" href="#pills-description" role="tab" aria-controls="pills-description" aria-expanded="true">Contact Details</a>
							    </li>
							    <li class="nav-item">
						  ...
						  <div class="tab-content" id="pills-tabContent">
						    <div class="tab-pane fade show active" id="pills-description" role="tabpanel" aria-labelledby="pills-description-tab">
						    	<div class="row">
						    		<div class="col-md-4">
						    			<ul class="features">
						    				<li class="check"><span class="ion-ios-checkmark-circle"></span><?php echo "<input type=text name=cont value= '".$row['Contactt']."'>";?>
 </li>
						    			</ul>
						    		</div>
						    ...
						    <div class="tab-pane fade" id="pills-manufacturer" role="tabpanel" aria-labelledby="pills-manufacturer-tab">
						      <p><?php echo "<input type=text name=desc value= '".$row['Descriptionn']."'>";?>
 </p>
						    </div>
