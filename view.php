        ...
        echo "<div class='col-md-4'>
        		<div class='property-wrap ftco-animate'>
                    ...
                    <button class="btn btn-danger btn-sm delete"
                        ...
                        <a href="delete.php?id=<?php echo $row['ImagesID']; ?>"> <buttom class='btn-success' > 
                          <span class='spinner-grow spinner-grow-sm'></span>Delete</button></a>

						  <a href="update.php?id=<?php echo $row['ImagesID']; ?>"> <buttom class='btn-success' > 
                          <span class='spinner-grow spinner-grow-sm'></span>Edit</button></a>
        		</div>
        	</div>
            <!-- a confirmation box for deleting of apartments -->
